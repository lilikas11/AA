...
def create_comparison_plots(greedy_data, exhaustive_data):
    ...
    for k in k_values:
            ...
            if '_75.' in filename:  # Apenas grafos de tamanho 75
                ...
                for measurement in measurements:
                    if measurement['k'] == k:
                        ...
                        times_greedy.append(measurement['decisions_made'])
            ...
            if '_75.' in filename:  # Apenas grafos de tamanho 75
                ...
                for measurement in measurements:
                    if measurement['k'] == k:
                        ...
                        times_exhaustive.append(measurement['configs_tested'])
        ...
        if vertices_exhaustive and vertices_greedy:
            ...
            if min_time > 0 and max_time / min_time > 100:  # Se a diferença for maior que 2 ordens de magnitude
                ax.set_yscale('log')
